...
if uploaded_file is not None:
    ...
    # Path to the buzzer sound file
    buzzer_sound_path = "D:/C DRIVE/Downloads/PPE_Detection/ppe_detection/buzzer.wav"  # Replace with your sound file path
    alert_triggered = False  # Initialize alert flag outside the loop
    ...
    while True:
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                # Trigger sound alert once for violations
                if class_name in ['NO-Hardhat', 'NO-Safety Vest', 'NO-Mask', 'NO-Person', 'NO-Gloves'] and not alert_triggered:
                    alert_triggered = True
                    playsound(buzzer_sound_path)  # Play sound for violations

        # Reset alert trigger for the next frame
